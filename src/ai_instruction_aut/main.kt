...
@OptIn(ExperimentalForeignApi::class) class StableWidget(val widget: CPointer<GtkWidget>?)
...
class EstandarWidgets(
        ...
        val entryAutorName: CPointer<GtkWidget>?
)
...
fun main() {
    ...
    val labelProyecto =
            gtk_label_new("Panel para generar instrucciones asociadas a un Proyecto específico.")
    ...
    gtk_entry_set_placeholder_text(
            ...
            "Ej: Aplicación e-commerce con catálogo y carrito..."
    )
    ...
    val lblEstilo =
            gtk_label_new(
                    "Estilo de código (ej: Guías oficiales de Google, identación 4 espacios):"
            )
    ...
    gtk_entry_set_text(
            ...
            "Guía de estilo oficial de Kotlin con 4 espacios"
    )
    ...
    gtk_entry_set_placeholder_text(
            ...
            "Ej: usar clases de datos y funciones de extensión..."
    )
    ...
    gtk_entry_set_placeholder_text(
            ...
            "Ej: no modificar archivos de configuración gradle..."
    )
    ...
    gtk_entry_set_placeholder_text(
            ...
            "Ej: usar inyección de dependencias con Koin..."
    )
    ...
    gtk_entry_set_placeholder_text(
            ...
            "Ej: Pruebas unitarias de Mockito en todos los usecases..."
    )
    ...
    gtk_entry_set_placeholder_text(
            ...
            "Ej: En tono formal, explicando parámetros..."
    )
    ...
    g_signal_connect_data(
            ...
            staticCFunction<COpaquePointer?, COpaquePointer?, Unit> { _, userData ->
                        ...
                        if (ref != null) {
                            ...
                            val activeRol =
                                    gtk_toggle_button_get_active(ref.checkRol?.reinterpret()) != 0
                            matrix.add(listOf("checkRol", activeRol.toString()))
                            matrix.add(
                                    listOf(
                                            "entryRol",
                                            gtk_entry_get_text(ref.entryRol?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            ...
                            val activeCtx =
                                    gtk_toggle_button_get_active(ref.checkCtx?.reinterpret()) != 0
                            matrix.add(listOf("checkCtx", activeCtx.toString()))
                            matrix.add(
                                    listOf(
                                            "entryCtx",
                                            gtk_entry_get_text(ref.entryCtx?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "entryArq",
                                            gtk_entry_get_text(ref.entryArq?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            ...
                            val activeEstilo =
                                    gtk_toggle_button_get_active(ref.checkEstilo?.reinterpret()) !=
                                            0
                            matrix.add(listOf("checkEstilo", activeEstilo.toString()))
                            matrix.add(
                                    listOf(
                                            "entryEstilo",
                                            gtk_entry_get_text(ref.entryEstilo?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            ...
                            val activeReglas =
                                    gtk_toggle_button_get_active(ref.checkReglas?.reinterpret()) !=
                                            0
                            matrix.add(listOf("checkReglas", activeReglas.toString()))
                            matrix.add(
                                    listOf(
                                            "entrySintaxis",
                                            gtk_entry_get_text(ref.entrySintaxis?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "entryModificar",
                                            gtk_entry_get_text(ref.entryModificar?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "entryArqFija",
                                            gtk_entry_get_text(ref.entryArqFija?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            ...
                            val activeTests =
                                    gtk_toggle_button_get_active(ref.checkTests?.reinterpret()) != 0
                            matrix.add(listOf("checkTests", activeTests.toString()))
                            matrix.add(
                                    listOf(
                                            "entryTests",
                                            gtk_entry_get_text(ref.entryTests?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            val activeTextTests =
                                    gtk_combo_box_text_get_active_text(
                                            ref.comboTests?.reinterpret()
                                    )
                            matrix.add(listOf("comboTests", activeTextTests?.toKString() ?: ""))

                            val activeDocu =
                                    gtk_toggle_button_get_active(ref.checkDocu?.reinterpret()) != 0
                            matrix.add(listOf("checkDocu", activeDocu.toString()))
                            matrix.add(
                                    listOf(
                                            "entryDocuEscrita",
                                            gtk_entry_get_text(ref.entryDocuEscrita?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            val activeTextFormato =
                                    gtk_combo_box_text_get_active_text(
                                            ref.comboFormatoDocu?.reinterpret()
                                    )
                            matrix.add(
                                    listOf("comboFormatoDocu", activeTextFormato?.toKString() ?: "")
                            )
                            val activeTextCuando =
                                    gtk_combo_box_text_get_active_text(
                                            ref.comboCuándoDocu?.reinterpret()
                                    )
                            matrix.add(
                                    listOf(
                                            "comboCu\u00e1ndoDocu",
                                            activeTextCuando?.toKString() ?: ""
                                    )
                            )

                            generateInstructionProject(matrix)
                        }
                    }
                    .reinterpret(),
    ...
    val labelEstandar =
            gtk_label_new("Panel para generar instrucciones estándar o genéricas de codificación.")
    gtk_label_set_xalign(labelEstandar?.reinterpret(), 0.0f)
    gtk_box_pack_start(scrollContentBox?.reinterpret(), labelEstandar, 0, 0, 10u)

    val lblAutor = gtk_label_new("Autor:")
    gtk_label_set_xalign(lblAutor?.reinterpret(), 0.0f)
    gtk_box_pack_start(scrollContentBox?.reinterpret(), lblAutor, 0, 0, 0u)
    val entryAutorName = gtk_entry_new()
    gtk_entry_set_text(entryAutorName?.reinterpret(), "Daniel Figueroa")
    gtk_box_pack_start(scrollContentBox?.reinterpret(), entryAutorName, 0, 0, 10u)
    ...
    gtk_entry_set_placeholder_text(
            ...
            "Ej: breves, verbos en imperativo..."
    )
    ...
    val lblEstiloCabecera =
            gtk_label_new("Estilo de cabeceras de documentación (ej. KDocs, JSDoc):")
    ...
    val checkBoxParaCabecerasDeClases =
            gtk_check_button_new_with_label("Habilitar cabeceras de clases")
    ...
    gtk_entry_set_placeholder_text(
            ...
            "Ej: Explicar brevemente la responsabilidad única..."
    )
    ...
    val checkBoxParaCabecerasFunciones =
            gtk_check_button_new_with_label("Habilitar cabeceras de funciones")
    ...
    val lblDescFunc =
            gtk_label_new("Indicación sobre cómo debe ser la descripción de las funciones:")
    ...
    gtk_entry_set_placeholder_text(
            ...
            "Ej: Resumir el algoritmo o comportamiento..."
    )
    ...
    val checkFuncThrows =
            gtk_check_button_new_with_label("@throws / @exception (Excepciones lanzadas)")
    ...
    val checkBoxParaComentariosInLine =
            gtk_check_button_new_with_label("Habilitar reglas para comentarios en línea")
    ...
    gtk_entry_set_placeholder_text(
            ...
            "Ej: Comentar solo lógica compleja y usar doble barra //"
    )
    ...
    val checkBoxParaNamesBranch =
            gtk_check_button_new_with_label("Habilitar reglas para nombres de ramas (Branches)")
    ...
    gtk_entry_set_text(
            ...
            "feature/nombre, bugfix/nombre, hotfix/nombre"
    )
                        ...
                        if (ref != null) {
                            ...
                            val activeCommits =
                                    gtk_toggle_button_get_active(
                                            ref.checkBoxParaCommits?.reinterpret()
                                    ) != 0
                            matrix.add(listOf("checkBoxParaCommits", activeCommits.toString()))
                            matrix.add(
                                    listOf(
                                            "entryInicio",
                                            gtk_entry_get_text(ref.entryInicio?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "entryInstruccionesCommits",
                                            gtk_entry_get_text(
                                                            ref.entryInstruccionesCommits
                                                                    ?.reinterpret()
                                                    )
                                                    ?.toKString()
                                                    ?: ""
                            ...
                            ref.commitEntries.forEachIndexed { idx, entryPtr ->
                                val text =
                                        gtk_entry_get_text(entryPtr?.reinterpret())?.toKString()
                                                ?: ""
                                matrix.add(listOf("commitPrefix_" + labels.getOrNull(idx), text))
                            }

                            val activeTextEstilo =
                                    gtk_combo_box_text_get_active_text(
                                            ref.comboEstilo?.reinterpret()
                                    )
                            matrix.add(listOf("comboEstilo", activeTextEstilo?.toKString() ?: ""))

                            val activeClases =
                                    gtk_toggle_button_get_active(
                                            ref.checkBoxParaCabecerasDeClases?.reinterpret()
                                    ) != 0
                            matrix.add(
                                    listOf("checkBoxParaCabecerasDeClases", activeClases.toString())
                            )
                            matrix.add(
                                    listOf(
                                            "entryDescClase",
                                            gtk_entry_get_text(ref.entryDescClase?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "checkClaseAutor",
                                            (gtk_toggle_button_get_active(
                                                            ref.checkClaseAutor?.reinterpret()
                                                    ) != 0)
                                                    .toString()
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "checkClaseFecha",
                                            (gtk_toggle_button_get_active(
                                                            ref.checkClaseFecha?.reinterpret()
                                                    ) != 0)
                                                    .toString()
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "checkClaseFile",
                                            (gtk_toggle_button_get_active(
                                                            ref.checkClaseFile?.reinterpret()
                                                    ) != 0)
                                                    .toString()
                                    )
                            )
                            ...
                            val activeFuncs =
                                    gtk_toggle_button_get_active(
                                            ref.checkBoxParaCabecerasFunciones?.reinterpret()
                                    ) != 0
                            matrix.add(
                                    listOf("checkBoxParaCabecerasFunciones", activeFuncs.toString())
                            )
                            matrix.add(
                                    listOf(
                                            "entryDescFunc",
                                            gtk_entry_get_text(ref.entryDescFunc?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "checkFuncAutor",
                                            (gtk_toggle_button_get_active(
                                                            ref.checkFuncAutor?.reinterpret()
                                                    ) != 0)
                                                    .toString()
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "checkFuncFecha",
                                            (gtk_toggle_button_get_active(
                                                            ref.checkFuncFecha?.reinterpret()
                                                    ) != 0)
                                                    .toString()
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "checkFuncParams",
                                            (gtk_toggle_button_get_active(
                                                            ref.checkFuncParams?.reinterpret()
                                                    ) != 0)
                                                    .toString()
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "checkFuncReturn",
                                            (gtk_toggle_button_get_active(
                                                            ref.checkFuncReturn?.reinterpret()
                                                    ) != 0)
                                                    .toString()
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "checkFuncThrows",
                                            (gtk_toggle_button_get_active(
                                                            ref.checkFuncThrows?.reinterpret()
                                                    ) != 0)
                                                    .toString()
                                    )
                            )
                            ...
                            val activeInline =
                                    gtk_toggle_button_get_active(
                                            ref.checkBoxParaComentariosInLine?.reinterpret()
                                    ) != 0
                            matrix.add(
                                    listOf("checkBoxParaComentariosInLine", activeInline.toString())
                            )
                            matrix.add(
                                    listOf(
                                            "entryInlineDesc",
                                            gtk_entry_get_text(ref.entryInlineDesc?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            ...
                            val activeBranch =
                                    gtk_toggle_button_get_active(
                                            ref.checkBoxParaNamesBranch?.reinterpret()
                                    ) != 0
                            matrix.add(listOf("checkBoxParaNamesBranch", activeBranch.toString()))
                            matrix.add(
                                    listOf(
                                            "entryBranchDesc",
                                            gtk_entry_get_text(ref.entryBranchDesc?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )
                            matrix.add(
                                    listOf(
                                            "entryAutorName",
                                            gtk_entry_get_text(ref.entryAutorName?.reinterpret())
                                                    ?.toKString()
                                                    ?: ""
                                    )
                            )

                            generateInstructionEstand(matrix)
                        }
                    }
                    .reinterpret(),
